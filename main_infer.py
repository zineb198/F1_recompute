...
if __name__ == '__main__':
    ...
    infer_sample_list = open("./data/stac_test_for_infer.txt").readlines()
...
with open("outputs/stac_predictions_attach.pkl", "wb") as output_file:
   pickle.dump(all_predict_link, output_file)
with open("outputs/stac_predictions_relation.pkl", "wb") as output_file:
   pickle.dump(all_predict_relation, output_file)
with open("outputs/stac_sample_utter.pkl", "wb") as output_file:
   pickle.dump(all_sample_utter_level, output_file)